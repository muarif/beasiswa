...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li <?php echo ($this->uri->segment(1) == 'dashboard') ? 'class="active"' : '';?>><a href="<?php echo site_url();?>"><i class="fa fa-tachometer"></i><span>Dashboard</span> </a> </li>
        <?php if($this->session->userdata('id_level')==1){ ?><li <?php echo ($this->uri->segment(1) == 'user') ? 'class="active"' : '';?>><a href="<?php echo site_url('user');?>"><i class="fa fa-user"></i><span>Users</span> </a> </li><?php } ?>
        <li <?php echo ($this->uri->segment(1) == 'kandidat') ? 'class="active"' : '';?>><a href="<?php echo site_url('kandidat');?>"><i class="fa fa-users"></i><span>Kandidat</span> </a> </li>
        <li <?php echo ($this->uri->segment(1) == 'peserta') ? 'class="active"' : '';?>><a href="<?php echo site_url('peserta');?>"><i class="glyphicon glyphicon-education"></i><span>Peserta</span> </a> </li>
        ...
        <?php if($this->session->userdata('id_level')==1){ ?><li <?php echo ($this->uri->segment(1) == 'tingkatan') ? 'class="active"' : '';?>><a href="<?php echo site_url('tingkatan');?>"><i class="fa fa-university"></i><span>Tingkatan</span> </a> </li><?php } ?>
      </ul>
    </div>
    <!-- /container --> 
  </div>
