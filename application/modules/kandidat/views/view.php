                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <div class="form-group <?php echo (form_error('nama_ortu')) ? 'has-error' : ''?>">                                         
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="nama_ortu" name="nama_ortu" value="<?php echo (set_value('nama_ortu'))?set_value('nama_ortu'):$data[0]['nama_ortu'] ?>">
                                                        </div> <!-- /controls -->
                                                    ...
                                                    <div class="form-group <?php echo (form_error('pekerjaan_ortu')) ? 'has-error' : ''?>">                                         
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="pekerjaan_ortu" name="pekerjaan_ortu" value="<?php echo (set_value('pekerjaan_ortu'))?set_value('pekerjaan_ortu'):$data[0]['pekerjaan_ortu'] ?>">
                                                        </div> <!-- /controls -->
